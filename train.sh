...
python train.py task=YumiCollect num_envs=256 graphics_device_id=0 sim_device='cuda:0' rl_device='cuda:0' ppo_deadless=True test=True checkpoint=runs/YumiCube3/nn/YumiCube.pth
