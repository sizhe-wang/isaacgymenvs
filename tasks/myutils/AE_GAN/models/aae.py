...
class AutoEncoder(torch.nn.Module):
    ...
    def decode(self, z: Tensor) -> Tensor:
        ...
        size = int(64 / (self.stride ** len(self.hidden_dims)))     # TODO: '64' is image size
        result = result.view(-1, num_feature, size, size)
    ...
    def loss_function(self,
        ...
        l2loss = F.mse_loss(recons, input)
        smoothl1loss = F.smooth_l1_loss(recons, input, beta=1./100)
        recons_loss = 10 * l2loss + smoothl1loss
