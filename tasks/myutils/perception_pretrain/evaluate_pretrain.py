...
from isaacgymenvs.tasks.myutils.perception_pretrain.resent_for_perception_pretrain import ResNet18
...
class YumiCube(VecTask):
    ...
    def __init__(self, cfg, sim_device, graphics_device_id, headless):
        ...
        self.net.load_state_dict(torch.load("nn/perception_pretrain_resnet18_classes6.pth"))
        self.net.eval()
    ...
    def compute_observations(self):
        ...
        loss = F.l1_loss(perception_output, target)
        print(loss)
