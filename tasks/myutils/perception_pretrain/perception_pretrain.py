...
class YumiCube(VecTask):
    ...
    def __init__(self, cfg, sim_device, graphics_device_id, headless):
        ...
        self.net.create_scheduler(milestones=[100, 200], gamma=0.1)
        self.net.train()
    ...
    def compute_observations(self):
        ...
        # print("image_tensors before", image_tensors[0])
        # Normalize
        image_tensors = image_tensors / 255.
        # print("image_tensors after1", image_tensors[0])
        # image_tensors = self.preprocess(image_tensors)
        # print("image_tensors after2", image_tensors[0])
        # exit()
...
if __name__ == "__main__":
    ...
    if not os.path.exists("nn"):
        os.mkdir("nn")
    torch.save(yumi.net.state_dict(), "nn/perception_pretrain_resnet18_classes6.pth")
